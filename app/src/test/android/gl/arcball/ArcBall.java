package test.android.gl.arcball;
...
public class ArcBall {
    ...
    public void mapToSphere(/*Point*/Point2f point, Vector3f vector) {
    ...
    // Mouse down
    public void click(/*Point*/Point2f NewPt) {
        mapToSphere(NewPt, this.StVec);

    }

    // Mouse drag, calculate rotation
    public void drag(/*Point*/Point2f NewPt, Quat4f NewRot) {
